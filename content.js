...
var CONTENT = {
  ...
  /* ══════════════════════════════════════════════════════
     ...
     HOW IT WORKS:
     ─────────────
     personalPics is a list of GROUPS.
     Each group has a title and a list of photos inside it.
     This lets you organise your pics into sub-sections like:
       → Trips, Friends, Random, Events, etc.

     DROP YOUR PHOTOS IN:  assets/images/personal/

     FOR EACH PHOTO:
       caption : text shown on hover (keep it casual!)
       image   : path to your photo file
                 → Leave as "" to show emoji placeholder
                 → Set to "assets/images/personal/filename.jpg" when ready
       emoji   : shown as placeholder when no image is set
       bg      : background colour (used behind emoji placeholder)

     TO ADD A NEW GROUP → copy a whole { title, photos:[...] } block
     TO ADD A PHOTO     → copy a { caption, image, emoji, bg } block inside photos:[]
     TO REMOVE A PHOTO  → delete its { } block (don't forget to remove trailing comma)
  ════════════════════════════════════════════════════════ */
  personalPics: [
    ...
    /* ── GROUP 1: TRIPS ── */
    {
      ...
      photos: [
        {
          caption: "Khandagiri, Odisha",
          image:   "assets/images/personal/khandagiri.png",   // ← you already added this!
          emoji:   "🏔️",
          bg:      "linear-gradient(135deg, #1a1000, #3a2800)"
        },
        {
          caption: "That view though",
          image:   "",             // ← add: "assets/images/personal/trip2.jpg"
          emoji:   "🌅",
          bg:      "linear-gradient(135deg, #2a1200, #5c2800)"
        },
        {
        ...
        /* Add more trip photos:
        ,{
          caption: "Your caption",
          image:   "assets/images/personal/yourphoto.jpg",
          emoji:   "📸",
          bg:      "linear-gradient(135deg, #111, #222)"
        }
        */
    ...
    /* ── GROUP 3: WITH PEOPLE ── */
    {
      ...
      photos: [
        ...
        },
        {
          ...
          image:   "",
          emoji:   "🫂",
          bg:      "linear-gradient(135deg, #100024, #1a0a3a)"
        }
      ]
    }

    /* ── TO ADD A NEW GROUP, copy this whole block: ──
    ,{
      title: "🎉 Your Group Name",
      photos: [
        {
          caption: "First photo caption",
          image:   "assets/images/personal/photo1.jpg",
          emoji:   "📸",
          bg:      "linear-gradient(135deg, #111, #222)"
        },
        {
          caption: "Second photo caption",
          image:   "assets/images/personal/photo2.jpg",
          emoji:   "🌟",
